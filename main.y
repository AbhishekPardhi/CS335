...
method_header:
    result method_declarator throws	{ NODE *cell = create_node(""); cell->list = {$1, $2, $3}; $$ = cell; }
|   type_parameters result method_declarator throws	{ NODE *cell = create_node(""); cell->list = {$1, $2, $3, $4}; $$ = cell; }
|   result method_declarator	{ NODE *cell = create_node(""); cell->list = {$1, $2}; $$ = cell; }
|   type_parameters result method_declarator	{ NODE *cell = create_node(""); cell->list = {$1, $2, $3}; $$ = cell; }
;

result:
    type	{ NODE *cell = create_node(""); cell->list = {$1}; $$ = cell; }
|   VOID	{ NODE *cell = create_node(""); cell->list = {$1}; $$ = cell; }
;
...
variable_initializer_list: 
    variable_initializer variable_init	{ NODE *cell = create_node(""); cell->list = {$1, $2}; $$ = cell; }
;

variable_init: 
    variable_init COMMA variable_initializer 	{ NODE *cell = create_node(""); cell->list = {$1, $2, $3}; $$ = cell; }
|   COMMA variable_initializer	{ NODE *cell = create_node(""); cell->list = {$1, $2}; $$ = cell; }
;
